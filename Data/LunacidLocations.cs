        ...
        public static readonly Dictionary<string, List<LocationData>> APLocationData = new(){
            ...
            },
            {
                ...
                new(){
                    ...
                    new LocationData( "FlA: Temple of Water Hidden Water Alcove (Left)", "WISP_HEART_PICKUP (1)", new Vector3(66.6f, 0.0f, -169.9f) ),
                    new LocationData( "FlA: Temple of Water Hidden Water Alcove (Right)", "WISP_HEART_PICKUP (1)", new Vector3(66.6f, 0.0f, -166.0f) ),
