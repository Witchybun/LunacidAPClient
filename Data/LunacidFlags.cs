...
namespace LunacidAP.Data
{
    public class LunacidFlags
    {
        public static readonly Dictionary<string, LunacidItemFlags> ItemToFlag = new(){
            ...
            { "Vampiric Symbol (W)", new LunacidItemFlags(new int[3]{24, 1, 1}, "CAS_1") },
            { "Vampiric Symbol (A)", new LunacidItemFlags(new int[3]{24, 2, 2}, "CAS_1") },
            { "Vampiric Symbol (E)", new LunacidItemFlags(new int[3]{24, 3, 3}, "CAS_1") },
