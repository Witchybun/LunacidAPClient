...
namespace LunacidAP.Data
{
    public class WarpDestinations
    {
        ...
        public static readonly Dictionary<string, WarpData> EntranceToWarp = new(){
            ...
            {"The Sanguine Sea to Accursed Tomb", new WarpData("HAUNT", new Vector3(76f, -7f, 103f), 180)},
            {"Accursed Tomb to The Sanguine Sea", new WarpData("LAKE", new Vector3(-170f, 9f, -71f), 90)},
            {"Accursed Tomb to Yosei Forest Lower", new WarpData("FOREST_A1", new Vector3(74f, -50f, -153f), 270)},
            {"Yosei Forest Lower to Accursed Tomb", new WarpData("HAUNT", new Vector3(3f, 2f, 1f), 90)},
